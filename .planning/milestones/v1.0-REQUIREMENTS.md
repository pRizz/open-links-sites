# Requirements Archive: v1.0 Control Repo MVP

**Archived:** 2026-03-18
**Status:** SHIPPED

This file is the frozen milestone-scoped requirements snapshot for `v1.0`. The next live requirements file will be created when the next milestone begins.
